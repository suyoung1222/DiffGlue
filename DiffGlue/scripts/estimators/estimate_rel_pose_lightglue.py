...
from models.lightglue.matching import Matching
...
matcher_config = {
    "superpoint": {
        ...
        / "/work/pi_hzhang2_umass_edu/suyoungkang_umass_edu/Git/DiffGlue/DiffGlue/scripts/models/weights/superglue_outdoor.pth",
