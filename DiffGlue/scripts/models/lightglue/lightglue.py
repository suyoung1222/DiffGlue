...
class LightGlue(nn.Module):
    ...
    def _forward(self, data: dict) -> dict:
        ...
        b, n, _ = kpts1.shape
        device = kpts0.device
        size0 = data['image0'].shape[2:]
        size1 = data['image1'].shape[2:]
        ...
        return {
            ...
            "prune0": prune0,
            "prune1": prune1,
            # Added for DiffGlue compatibility:
            "image0": data["image0"],
            "image1": data["image1"],
            ...
            "mean": scores,  # placeholder
            "variance": torch.ones_like(scores) * 0.1,
            "log_variance": torch.log(torch.ones_like(scores) * 0.1),
            "pred_xstart": scores,
            "sample": scores,
        }
