...
# DATA_PATH = Path("/home/suyoung/mydata/Diffglue/data/")
# TRAINING_PATH = Path("/home/suyoung/mydata/Diffglue/outputs/training/")  # training checkpoints
# EVAL_PATH = Path("/home/suyoung/mydata/Diffglue/outputs/results/")  # evaluation results
